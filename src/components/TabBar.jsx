const TABS = [
  ...
  { key: "shipments", label: "SHIPMENTS", num: "5", subtitle: "Chokepoint traffic, Red Sea / Hormuz incidents" },
  { key: "labor", label: "LABOR", num: "6", subtitle: "Unemployment, payrolls, claims, layoffs" },
  { key: "global", label: "GLOBAL", num: "7", subtitle: "World indices, FX, commodities, yields" },
  { key: "risk", label: "RISK", num: "8", subtitle: "VIX, credit spreads, financial stress" },
  { key: "sentiment", label: "SENTIMENT", num: "9", subtitle: "Fear & Greed, sectors, Reddit buzz" },
  { key: "capitol", label: "CAPITOL", num: "0", subtitle: "Politician trading — STOCK Act filings" },
